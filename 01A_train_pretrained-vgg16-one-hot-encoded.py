...
from helper import print_metrics, plot_accuracy, load_data_files_one_hot_encoded
...
# Load the data
X_train, X_val, X_test, y_train_one_hot_encoded, y_val_one_hot_encoded, y_test_one_hot_encoded = load_data_files_one_hot_encoded()
...
history = model.fit(X_train, y_train_one_hot_encoded,
                    ...
                    validation_data=(X_val, y_val_one_hot_encoded))

# Save the model
model.save('results/vgg16_one_hot_encoded.keras')

# Plot the accuracy
plot_accuracy(history)

# Evaluate the model on the test set
eval_result = model.evaluate(X_test, y_test_one_hot_encoded, verbose=1)
